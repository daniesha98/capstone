    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="e.g. house/flat no.">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. Melaka">
            </div>
            <div class="inputBox">
                <span>state :</span>
                <input type="text" name="state" placeholder="e.g. Kuala Lumpur">
            </div>
            <div class="inputBox">
                <span>country :</span>
            ...
            <div class="inputBox">
                <span>post code :</span>
                <input type="number" min="0" name="pin_code" placeholder="e.g. 56000">
            </div>
        </div>

        <input type="submit" name="order" value="Book Now" class="btn">
